// TODO(ak): merge with `table` (which is currently round-only)
...
import { calculateLongTableDotPositions } from './math.ts';

export interface LongTableState extends BaseState, WithSeatsState, WithRotationState {
	kind: 'long-table';
	config: {
		type: 'long';
		width: number;
...
export interface LongTableProps extends BaseCanvasProps<LongTableState> {}

export function LongTable(props: LongTableProps) {
